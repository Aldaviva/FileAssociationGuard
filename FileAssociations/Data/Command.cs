namespace FileAssociations.Data {
    ...
    public class Command {
        ...
        /// <summary>The command-line invocation of a program which may contain <c>%</c> placeholders (such as <c>%1</c>, <c>%*</c>, or <c>%SYSTEMROOT%</c>), such as <c>"c:\myprogram.exe" "%1"</c>.</summary>
